exports.handler = async (event) => {
  ...
  try {
    ...
    // Zaawansowany prompt dla modelu Flux Dev Inpainting zapewniający najwyższą jakość premium
    ...
    // Używamy profesjonalnego modelu flux/dev/inpainting zapewniającego kinową jakość
